Assume $f(x)$ has $L$- Lipschitz continuous gradient, then as long as the stepsize $\alpha\in(0, \frac{2}{L})$. Then the sequence $\{x^k\}_{k=0}^{+\infty}$ generated by the gradient descent,
